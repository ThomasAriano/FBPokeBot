...
function paintGUI()
{
    ...
    infoDiv.innerHTML = "PokeBot v420";
    ...
    var btnPoke = document.createElement("Button");
    btnPoke.appendChild(document.createTextNode("Poke All"));
    btnPoke.id = "btn_forcePoke";
    btnPoke.style.position = "absolute";
    btnPoke.style.left = "220px";
    btnPoke.style.top = "18px";
    btnPoke.onclick = function() {
        console.log("Force poking all...");
        var pokeLinks =  Array.prototype.slice.call(document.getElementsByTagName("a")).filter(function (goodLink) {
            return (goodLink.innerHTML.contains("Poke Back"));
        });
        for (var i = 0 ; i != pokeLinks.length; i++) {
    ...
    document.getElementsByClassName("uiHeader _5i1b uiHeaderPage")[0].appendChild(btnPoke);
}
